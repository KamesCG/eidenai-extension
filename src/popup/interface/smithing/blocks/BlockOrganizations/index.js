...
<Flex direction={['row']} align={"stretch"} justify="center" wrap='wrap'>
  <Flex align="left" justify="left" w={[0.35]} pl={[15]} py={[7]} direction={['column']} >
    ...
    <Link to="/"><Image src={graphics.iconEidenai} display='inline-block' mr={5} w={[20,27]} /><Heading color={'white'} level={4} margin={'0'} display='inline-block' fontSize={[4,5]} fontWeight={'100'}>Eidenai</Heading></Link>
